...
class _DocumentsScreenState extends ConsumerState<DocumentsScreen> {
                    ...
                    if (uploading)
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          ...
                          final url =
                              await SupabaseStorageHelper.pickAndUploadFile(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('MURAL DE DOCUMENTOS')),
      body: Container(
        decoration: const BoxDecoration(color: SteampunkTheme.leatherBark),
        child: _isLoading
            ? const Center(
